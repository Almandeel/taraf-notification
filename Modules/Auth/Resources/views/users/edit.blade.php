									...
									<tbody>
										...
										<tr>
											...
											<td>@if($create) <input type="checkbox"
													...
													{{ $user->hasPermission($create->name) ? 'checked' : '' }} value="{{ $create->id }}" /> @else - @endif</td>
											<td>@if($read) <input type="checkbox"
													class="permission-{{ $name }} permission-read-{{ $name }} permission-{{ $group->first()->group() }}" name="permissions[]"
													{{ $user->hasPermission($read->name) ? 'checked' : '' }} value="{{ $read->id }}" /> @else - @endif</td>
											<td>@if($update) <input type="checkbox"
													...
													{{ $user->hasPermission($update->name) ? 'checked' : '' }} value="{{ $update->id }}" /> @else - @endif</td>
											...
											<td>@if($dashboard) <input type="checkbox"
												...
												{{ $user->hasPermission($dashboard->name) ? 'checked' : '' }} value="{{ $dashboard->id }}" /> @else - @endif</td>
										</tr>
										@endforeach
									</tbody>
								</table>
					...
					<tbody>
						@foreach ($permissions->groupBy('description') as $group)
							...
							<tr>
								...
								<td>@if($create) <input type="checkbox" class="permission permission-create permission-{{ $group->first()->group() }}" name="permissions[]" {{ $user->hasPermission($create->name) ? 'checked' : '' }} value="{{ $create->id }}" /> @else - @endif</td>
								<td>@if($read) <input type="checkbox" class="permission permission-read permission-{{ $group->first()->group() }}" name="permissions[]" {{ $user->hasPermission($read->name) ? 'checked' : '' }} value="{{ $read->id }}" /> @else - @endif</td>
								<td>@if($update) <input type="checkbox" class="permission permission-update permission-{{ $group->first()->group() }}" name="permissions[]" {{ $user->hasPermission($update->name) ? 'checked' : '' }} value="{{ $update->id }}" /> @else - @endif</td>
								<td>@if($delete) <input type="checkbox" class="permission permission-delete permission-{{ $group->first()->group() }}" name="permissions[]" {{ $user->hasPermission($delete->name) ? 'checked' : '' }} value="{{ $delete->id }}" /> @else - @endif</td>
								<td>@if($print) <input type="checkbox" class="permission permission-print permission-{{ $group->first()->group() }}" name="permissions[]" {{ $user->hasPermission($print->name) ? 'checked' : '' }} value="{{ $print->id }}" /> @else - @endif</td>
								<td>@if($send) <input type="checkbox" class="permission permission-send permission-{{ $group->first()->group() }}" name="permissions[]" {{ $user->hasPermission($send->name) ? 'checked' : '' }} value="{{ $send->id }}" /> @else - @endif</td>
							</tr>
						@endforeach
					</tbody>
				</table> --}}
