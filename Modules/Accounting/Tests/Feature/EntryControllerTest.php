...
class EntryControllerTest extends TestCase
{
    ...
    * @group accounting-entries
    */
    public function can_advrse_entry_test()
    {
        ...
        $this->assertYearIsActive();
        $entry = factory(Entry::class)->create();
        $response = $this->actingAs($this->user)->json('POST', '/accounting/entries/', [
        'operation' => 'adverse',
        'ajax' => true,
        'entry_id' => $entry->id,
        ]);
        ...
        $this->assertCount(1, Entry::where('entry_id', $entry->id)->get());
    }
