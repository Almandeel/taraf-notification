                            ...
                            @slot('body')
                                <div class="form-group row">
                                    <div class="col">
                                        ...
                                        <select name="debt_account" id="debt_account" class="form-control accounts" required></select>
                                    </div>
                                    <div class="col">
                                        <label for="credit_account">@lang('accounting::global.to')</label>
                                        <select name="credit_account" id="credit_account" class="form-control accounts" required></select>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col">
