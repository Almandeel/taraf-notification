                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <h3 class="card-title float-right">
                                        <a class="btn btn-primary btn-sm" href="{{ route('accounting.custodies.create') }}"><i class="fa fa-plus"></i> إضافة</a>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    ...
                                                    <a href="{{ route('accounting.custodies.show', $custody) }}" class="btn btn-info">
                                                        <i class="fa fa-eye"></i>
                                                        <span>@lang('global.show')</span>
                                                    </a></li>
                                                    @endpermission
                                                    @permission('custodies-update')
                                                    <a href="{{ route('accounting.custodies.edit', $custody) }}" class="btn btn-warning">
                                                ...
                                                @permission('custodies-delete')
                                                <form id="deleteForm-{{ $custody->id }}" action="{{ route('accounting.custodies.destroy', $custody) }}" method="POST">
                                                    @csrf
                                                    @method('DELETE')
                                                </form>
                                                @endpermission
