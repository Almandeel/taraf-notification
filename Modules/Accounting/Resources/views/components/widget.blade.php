<div class="card card-{{ isset($type) ? $type : 'primary' }} {{ isset($collapsed) ? 'collapsed-card' : '' }} {{ isset($not_oulined) ? '' : 'card-outline' }} {{ isset($sticky) ? ' p-sticky t-15  ' : '' }} {{ isset($classes) ? $classes : '' }}">
    @isset($title)
