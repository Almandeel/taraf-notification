...
use Modules\Accounting\Models\{Entry, Bill, Invoice, Payment};
...
class PaymentController extends Controller
{
    ...
    */
    ...
    {
        $payments = Entry::all();
        return view('accounting::dashboard.payments.index', compact('payments'));
    }
    ...
    */
    ...
    {
        return view('accounting::dashboard.payments.show', compact('customer'));
