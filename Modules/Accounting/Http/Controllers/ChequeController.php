...
use Carbon\Carbon;
use Modules\Accounting\Models\{Cheque, Account, Bill, Invoice, Payment};
use Illuminate\Http\Request;
use Modules\Accounting\Models\{Customer, Supplier, Employee, Collaborator};
use Modules\Accounting\Models\Events\ChequeCreatedEvent;
...
class ChequeController extends Controller
{
    ...
    */
    public function index(Request $request)
    {
        ...
        return view('accounting::dashboard.cheques.index', compact('cheques', 'advanced_search', 'using_dates', 'status', 'type', 'from_date', 'to_date', 'beneficiaries', 'customers', 'suppliers', 'employees', 'collaborators'));
    }
    
    public function create()
    {
        return view('accounting::dashboard.cheques.create');
    }
    
    public function show(Cheque $cheque)
    {
        return view('accounting::dashboard.cheques.show', compact('cheque'));
    }
