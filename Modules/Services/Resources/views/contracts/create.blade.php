            ...
            @slot('body')
                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        <td style="padding: 0px;"><input type="text" style="border-radius: 0;" class="form-control" name="visa" placeholder="التأشيرة"></td>
                    </tbody>
                </table>
                <div class="row">
                    <div class="col">
                        <div class="form-group">
                            ...
                            <input required type="number" class="form-control" name="amount" placeholder="Amount" step="0.01" value="0">
                        </div>
                    </div>
                    <div class="col">
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="status">
                                @foreach ($statuses as $value => $status)
                                    <option value="{{ $value }}">@lang('contracts.statuses.' . $status)</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
