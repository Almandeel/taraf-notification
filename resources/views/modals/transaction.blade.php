            ...
            <div class="modal-body">
                ...
                <div class="form-group row">
                    <div class="col-md-6">
                        ...
                        @foreach (Modules\Employee\Models\Transaction::TYPES as $value => $key)
                        <label>
                            <input type="radio" name="type" value="{{ $value }}" id="type-{{ $value }}" @if ($value == Modules\Employee\Models\Transaction::TYPE_DEBT) checked="checked" @endif />
                            <span>{{ $key }}</span>
                        </label>
                        @endforeach
                    </div>
